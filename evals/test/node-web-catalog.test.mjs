...
test("lists canonical node-web commands in tool selection guidance", () => {
  const toolSelection = read("skills/security-test-rig/references/tool-selection.md");
  const sampleCommands = read("skills/security-test-rig/references/sample-commands.md");
